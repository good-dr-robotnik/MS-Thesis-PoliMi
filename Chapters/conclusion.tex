...
It proved to be non-trivial to produce films which, upon annealing, crystallized into phase-pure perovskite \PTO{}. Instead, the films often degrade into a mixture of PTO, various lead oxides (\ce{PbO_{x}}), various titanium oxides (primarily \ce{TiO2}), and possibly pyrochlore forms (\ce{PbTi3O7} and \ce{Pb2Ti2O6}). At this time it is unclear exactly what causes this behavior. Additional research into the thermodynamics and crystallization behavior of these films would be of great value. 
