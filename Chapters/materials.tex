...
\begin{figure}[tb]
   ...
   \subfloat[][Paraelectric]{%
   	\label{fig:EvP-PE}%
	\includegraphics[width=0.45\linewidth]{./figures/materials/EvP-FE2.pdf}%
	} 	
   \subfloat[][Ferroelectric]{%
   	\label{fig:EvP-FE}%
	\includegraphics[width=0.45\linewidth]{./figures/materials/EvP-FE1.pdf}%
	} 	
