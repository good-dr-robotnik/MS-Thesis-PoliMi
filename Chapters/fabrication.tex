...
Samples of both of these compounds were obtained from Strem Chemicals, inc. Analysis of the precursors included thermal tests (TGA and DSC, see section~\vref{chap:Results-Thermal}) as well as test depositions of ALD films. The precursor chosen for use after testing was \TMHD{}, and films discussed further solely utilized this compound. 
