...
Lead sources investigated included bis(2,2,6,6-tetramethyl-3,5-heptanedionato)lead(II) (\ce{Pb(TMHD)2}) and lead(II) hexafluoroacetylacetonate (\ce{Pb(HFAc)2}). Both compounds had been referenced in literature \reword{[citation needed]}, were widely available from multiple chemical suppliers, and were expected to have the highest vapor pressure of the choices available at the time. 
