...
In order for the desired phase to be preferentially formed during the annealing process, without any impurity phases nucleating, it is important to be able to control the stoichiometry of the produced film. Previous reports have shown that there is a close relationship between the composition of the film and the final resultant phase (see figure~\ref{fig:PTO-phase}). 
