...
\begin{align}
	\epsilon_{1}\left(\omega\right)-1&=\frac{2}{\pi}P\int^{\infty}_{0}\frac{\omega\prime\epsilon_{2}\left(\omega\prime\right)}{\omega\prime^{2}-\omega^{2}}d\omega\prime\\
	\epsilon_{2}\left(\omega\right)&=-\frac{2\omega}{\pi}P\int^{\infty}_{0}\frac{\epsilon_{1}\left(\omega\prime\right)-1}{\omega\prime^{2}-\omega^{2}}d\omega\prime
\end{align}
\end{subequations}
...
Experimental data sets and the resulting fitted model for selected samples are presented in appendix~\vref{sup:Ellipsometry}.
