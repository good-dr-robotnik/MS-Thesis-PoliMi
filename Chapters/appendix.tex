...
\begin{figure}[htbp]
  ...
  \subfloat[$n$, $k$ vs. Photon Energy][$n$, $k$ vs. Photon Energy (eV)]{%
	...
	\includegraphics[width=0.47\textwidth]{./Figures/Appendix/Ellipsometry/Run-0-SiO2/n,k,Egap.pdf}%
	} \hspace{0.5cm}
   \caption[Results of Ellipsometry Experiments on Sample \#0]%
...
\begin{figure}[htbp]
  ...
  \subfloat[Tauc ($\alpha^{2}E_{ph}^{2}$) vs. Photon Energy][Tauc ($\alpha^{2}E_{ph}^{2}$) vs. Photon Energy (eV)]{%
   ...
   \caption[Results of Tauc Analysis on Sample \#0]%
   		{Tauc analysis is used to determine the bandgap of a semiconductor. Direct bandgap materials, such as %
		\PTO{}, have the variables squared; indirect bandgaps instead have square roots. (a) shows the %
