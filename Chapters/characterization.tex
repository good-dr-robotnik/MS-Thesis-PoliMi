...
This project used two XRD instruments, a Br¬\"uker D8 Discover XRD and a Rigaku SmartLab XRD (see figures~\ref{fig:bruker-d8-photo} and \vref{fig:rigaku-smartlab-photo}). Both sources utilized a Cu-K$_{\alpha}$ X-ray source ($\lambda = 1.5418$\AA). 
...
Both instruments are capable of collected data in GIXRD mode (fixed $\omega$--2$\theta$). 
