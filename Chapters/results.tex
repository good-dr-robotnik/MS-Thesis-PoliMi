...
\begin{figure}[htbp]
	...
	\caption[XRD Scan of \#23 on Pt]%
		{This data shows the result of diffractometry on sample \#23 Pt-Si. In this sample there are present a %
		variety of phases. The inset shows the splitting of the \PTO{} peak, due to the tetragonal nature of the %
		unit cell.}
